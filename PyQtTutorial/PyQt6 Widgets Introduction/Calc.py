...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_seond = QtWidgets.QLineEdit(parent=Form)
        font = QtGui.QFont()
        font.setPointSize(12)
        self.lineEdit_seond.setFont(font)
        self.lineEdit_seond.setObjectName("lineEdit_seond")
        self.horizontalLayout_2.addWidget(self.lineEdit_seond)
...
"}")
    ...
    def add(self):
        ...
        secnum = int(self.lineEdit_seond.text())
    ...
    def multiply(self):
        ...
        result = fnum * secnum
        self.label_result.setText("Miltiplication: {}".format(result))  
